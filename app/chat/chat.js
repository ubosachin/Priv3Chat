...
export default function Chat() {
  ...
  return (
    <div className={`flex h-screen ${isDarkMode ? "dark" : ""} bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500`}>
      {/* Sidebar */}
      <div className="w-1/3 border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 bg-opacity-90 dark:bg-opacity-90">
        {/* Header */}
        <div className="p-4 flex justify-between items-center border-b border-gray-200 dark:border-gray-700">
          {/* <Button variant= "outline" onClick={toggleDarkMode} className="rounded-full">
